...
const STORAGE_KEYS = {
  ...
  /**
   * HỒNG PHÚC (Lưu % lợi nhuận theo loại sản phẩm)
   */
  CATEGORY_PROFITS: "phonestore_category_profits",

  /**
   * HỒNG PHÚC (Lưu % lợi nhuận theo từng sản phẩm)
   */
  PRODUCT_PROFITS: "phonestore_product_profits",
